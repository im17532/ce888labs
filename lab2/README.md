...
![logo](./vehiclesCurrent_histogram.png?raw=true)
![logo](./VehiclesNew_histogram.png?raw=true)
![logo](./bootstrapNew_confidence.png?raw=true)
![logo](./bootstrapCurrent_confidence.png?raw=true)
...
- The analysis of the upoladed files was done in order to determine whether a business company should stick to its current fleet or it should replace it with a new one. Data was available from a Japanese VS American cars MPG comparison. Scatterplots and histograms were used to visualize the comparison, as well as bootstrap sampling to measure accuracy.

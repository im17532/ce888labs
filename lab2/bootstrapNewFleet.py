...
if __name__ == "__main__":
    ...
    for i in range(10, 10000, 100):
        boot = boostrap(np.std, i, data_clean)
    ...
    sns_plot.savefig("bootstrapNew_confidence.png", bbox_inches='tight')
    sns_plot.savefig("bootstrapNewB_confidence.pdf", bbox_inches='tight')
